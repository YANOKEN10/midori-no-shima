const images=new Map(['dock-floor140','rowboat140','yacht140'].map(key=>{const im=new Image();im.src=new URL(key==='dock-floor140'?'../assets/harbor-v141/dock-floor.png':'../assets/harbor-v140/'+key+'.png',import.meta.url).href;return[key,im];}));
