...
export const SPECIES = {
  リーフィン: {
    ...
    learn: [[1, "タックル"], [1, "ボイス"], [7, "つるのムチ"], [13, "やどりぎ"], [20, "はっぱカッター"], [27, "こうごうせい"], [34, "ソーラーリーフ"]],
  ...
  リーフォード: {
    ...
    learn: [[1, "タックル"], [1, "つるのムチ"], [15, "やどりぎ"], [22, "はっぱカッター"], [30, "こうごうせい"], [38, "ソーラーリーフ"]],
    dex: "せなかの はっぱが かたくなり、たてのように つかう。もりの みはりやく。",
  },
  フォレスタ: {
    no: 3, types: ["くさ"], base: { hp: 80, atk: 82, def: 83, spd: 80, spc: 100 },
    catch: 45, exp: 208,
    learn: [[1, "はっぱカッター"], [1, "タックル"], [25, "こうごうせい"], [36, "ソーラーリーフ"], [44, "マックスアタック"]],
  ...
  ヒノコマ: {
    ...
    learn: [[1, "ひっかく"], [1, "ボイス"], [9, "ファイア"], [16, "スピードブロー"], [25, "ひばしら"], [34, "ファイアブラスト"]],
  ...
  ボウエン: {
    ...
    learn: [[1, "ひっかく"], [1, "ファイア"], [18, "スピードブロー"], [27, "ひばしら"], [36, "ファイアブラスト"], [42, "マックスアタック"]],
    dex: "たてがみが もえあがると、あたりの きおんが ぐんと あがる。",
  },
  エンブレイズ: {
    no: 6, types: ["ほのお"], base: { hp: 78, atk: 84, def: 78, spd: 100, spc: 109 },
    catch: 45, exp: 209,
    learn: [[1, "ファイア"], [1, "ひっかく"], [30, "もえるつばさ"], [38, "ファイアブラスト"], [46, "マックスアタック"]],
  ...
  アワミィ: {
    ...
    learn: [[1, "タックル"], [1, "しっぽふり"], [8, "ウォーターブロー"], [15, "ブロック"], [22, "アクアピストル"], [31, "アクアマシンガン"], [39, "ウォーターレーザー"]],
  ...
  ウズマリン: {
    ...
    learn: [[1, "ウォーターブロー"], [1, "しっぽふり"], [18, "アクアピストル"], [26, "ブロック"], [34, "アクアマシンガン"], [41, "ウォーターレーザー"]],
  ...
  ピリット: {
    ...
    learn: [[1, "イナズマ"], [1, "しっぽふり"], [10, "サンダー"], [18, "イナズマボール"], [26, "スピードブロー"], [34, "サンダーマジック"]],
  ...
  ヨルネコ: {
    ...
    learn: [[1, "ひっかく"], [1, "いかく"], [11, "シャドーアタック"], [20, "かみつく"], [29, "ダウンバグ"], [37, "ブラックカッター"]],
    dex: "よるに なると めが ひかる。かげの なかを すべるように あるく。",
  },
  シャドネコ: {
    no: 22, types: ["やみ"], base: { hp: 70, atk: 90, def: 65, spd: 110, spc: 80 },
    catch: 60, exp: 158,
    learn: [[1, "シャドーアタック"], [1, "いかく"], [30, "ダウンバグ"], [36, "ダークブレイン"], [45, "ブラックカッター"], [50, "ムゲン"]],
  ...
  ヌシガエル: {
    ...
    learn: [[1, "ウォーターブロー"], [1, "かみつく"], [30, "アクアマシンガン"], [38, "ロッククラッシュ"], [46, "ウォーターレーザー"], [52, "パワーアップ"]],
