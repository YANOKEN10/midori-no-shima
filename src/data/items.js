...
export const ITEMS = {
 ...
 "ハイラス・エンブレム":{kind:"key",price:0,desc:"試験を乗り越えた証。"},
 ...
 "マニケレオ・エンブレム":{kind:"key",price:0,desc:"ヨウガン山の試験に合格した証。"},
  ...
  "カラット・エンブレム": {kind:"key",price:0,desc:"ラーデン発電所の試験に 合格した証。"},
  "船のチケット": {kind:"key",price:0,desc:"カラット港と レスレ港を結ぶ船の 乗船券。何度でも使える。"},
  /* --- たいせつな もの --- */
  "ガオンずかん": { kind: "key", price: 0, desc: "であった ガオンが きろくされる。" },
  "リーフ・コンパス": { kind: "key", price: 0, desc: "葉脈の光で、つぎに声を聞くべき土地を示す。" },
  "マリンエンブレム": {kind:"key",price:0,desc:"はなれの湖で エビゲルの試験に合格した証。"},
...
export const EMBLEMS = [
  "マリンエンブレム", "カラット・エンブレム", "レスレ・エンブレム", "マニケレオ・エンブレム",
  "クリア・エンブレム", "ハイラス・エンブレム", "ダーク・エンブレム",
];
