...
export function frontierGate(wp,s){
 ...
 if(wp.requires==='frontier:five'&&count<5)return ['警備員「エンブレム５個が必要です。','今は この先へ進めません。」'];
