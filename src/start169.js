...
export function showStart169(){
 return new Promise(resolve=>{
  ...
  root.innerHTML=`<img class="start-art169" src="/assets/start-v170/ensemble.webp" alt=""><div class="start-shade169"></div><div class="start-logo169"><p class="start-kicker169">GAON WORLD</p><h1></h1><p class="start-tag169"></p></div><div class="start-actions169"><button type="button" autofocus></button><p class="start-hint169"></p></div>`;
