...
export function asset(c,key,x,y,w,h){if(drawReadable84(c,key,x,y,w,h))return true;if(endAsset(c,key,x,y,w,h))return true;const im=images[key];if(!im?.complete||!im.naturalWidth)return false;c.drawImage(im,x,y,w,h);return true;}
