...
export function mountainForest(c,map){if(map.forestObjects131||!mountainReady())return;for(const p of forestLayout(map))mountainMaterial(c,'fir',p.x,p.y,p.w,p.h);}
