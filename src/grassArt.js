...
export function drawBiomeGrass(c,map,x,y){if(map.biome)return drawMarineAsset(c,'reeds',x,y,32,32);const theme=grassTheme(map);if(!theme)return false;const im=images[theme];if(im.complete&&im.naturalWidth)c.drawImage(im,x,y,32,32);return true;}
