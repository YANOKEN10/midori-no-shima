export const LESSONS100={
 walk:{title:'歩く・人と話す',lines:['スマホは 左の丸いボタンを動かすと歩けるよ。','人の方を向いて Aをおすと お話できるよ。','パソコンは 矢印キーで歩こう。','Enterか Zで話す。Xか Escでもどるよ。','まずは ネイチャータウンの女の子に 話を聞いてみよう！']},
 catch:{title:'ガオンをつかまえる',lines:['まずは 山おくでラテットに会って、はかせに知らせよう。','はかせから ラグネットを15個もらえるよ。','草むらで 野生のガオンに会ったら どうぐからラグネットを使おう。','たいりょくを少なくすると つかまえやすくなるよ。','倒してしまう前に ラグネットを使ってね。','人のガオンや 試験の相手は つかまえられないよ。']},
 ...
 battle:{title:'バトルとタイプ',lines:['なかまのわざをえらんで バトルしよう。','たとえば ほのおのわざは くさタイプに強いよ。','みずのわざは ほのおタイプに強いよ。','ちがうタイプのなかまを連れると 得意な相手がふえるね。','PPは わざを使える残りの回数だよ。']},
 moves:{title:'新しいわざをおぼえる',lines:['レベルが上がると 新しいわざをおぼえることがあるよ。','１種類のガオンが 約20個のわざを学べるよ。','バトルで使えるわざは ４つまで。','４つあるときは 今のわざを１つ忘れて 新しいわざにできるよ。','忘れたわざは 黄色い屋根の思い出し屋で！','ロッズタウンのレミが 思い出すのを手伝ってくれるよ。']},
 menu:{title:'メニューと図鑑',lines:['スマホは START、パソコンは Eでメニューをひらこう。','なかまや どうぐをたしかめられるよ。','ロッズタウンのヤノケンから ガオンずかんをもらおう。','同じ場所でも 曜日や時間で会えるガオンが変わるよ。','わからなくなったら また話しかけてね！']}
};
