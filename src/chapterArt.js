...
function drawChapterBase72(ctx,map,camX,camY){
 if(!resourceArtReady85()||!readableReady84()||!activeReady83()||!clinic81.complete||!clinic81.naturalWidth||!signReady()||!cottage.complete||!cottage.naturalWidth){ctx.fillStyle='#172d36';ctx.fillRect(0,0,G.W,G.H);return true;}
